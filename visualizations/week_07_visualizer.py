...
===========================================================
    ...
    3. Weighted sum of values
       +-----------------------------------+
       | output = 0.52xV_1 + 0.28xV_2 + 0.20xV_3 |
       +-----------------------------------+
    """)
    pause()
...
Step 1: Create Q, K, V for each token
    ...
    print("""
Step 2: Compute attention scores (Q x K^T)
===========================================================
...
After softmax (rows sum to 1):
    ...
    print("""
Step 3: Compute output (attention x values)
===========================================================

    Output_1 = 0.50xV_1 + 0.28xV_2 + 0.22xV_3
    Output_2 = 0.24xV_1 + 0.48xV_2 + 0.28xV_3
    Output_3 = 0.18xV_1 + 0.38xV_2 + 0.44xV_3
...
===========================================================
    ...
    Combine:
        MultiHead = Concat(head_1, ..., head_8) x W_O
                  = [64, 64, 64, 64, 64, 64, 64, 64] x W_O
                  = [512 dims]
...
===========================================================
    ...
    Before softmax, add large negative to future positions:
              ...
              0     1     2     3
            +-----+-----+-----+-----+
    pos 0   |  0  | -inf  | -inf  | -inf  |  can only see itself
            +-----+-----+-----+-----+
    pos 1   |  0  |  0  | -inf  | -inf  |  can see 0,1
            +-----+-----+-----+-----+
    pos 2   |  0  |  0  |  0  | -inf  |  can see 0,1,2
            +-----+-----+-----+-----+
...
CACHE the K and V values from previous steps!
    ...
    for i, token in enumerate(tokens):
        ...
        print(f"    Q_{i+1} (new) x [K_1...K_{i+1}] (cached) = weights")
        print(f"    weights x [V_1...V_{i+1}] (cached) = output")
        print()
